...
function showMessage(title, description) {
  ...
  document.getElementById('claim-offer-btn').addEventListener('click', function () {
      ...
      fetch('https://script.google.com/macros/s/AKfycby94tjYX7z6SqXzxE3Q9z0WU3-l4DhDxiznbOWTKa7k5haKd8YNAzh6oLr5LB5btuyz/exec', {
          method: 'POST',
          headers: {
  ...
  function checkQrStatus(qrToken) {
      ...
      fetch(`https://script.google.com/macros/s/AKfycbyAQc6nQm6oxHog1Mo9G-4nv8UCcHEeGXY71pEyKQH6JPRnnYzWQjcjK8ix2pxmcnXI/exec?qrToken=${qrToken}`)
          .then(response => response.json())
          .then(data => {
